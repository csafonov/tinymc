...
#undef PI // for those who frequently uses PI as a variable

#include "tmcdebugger.h"
// for debugging
void tmcDisplayMatF(FILE *fp,tmsMatrix *x,short bVerb);
/// Additional exports
long tmcGetM(tmsMatrix *res);
long tmcGetN(tmsMatrix *res);
long tmcGetType(tmsMatrix *res);
short tmcHasIm(tmsMatrix *res);
double tmcScalarVal(tmsMatrix *res);
double tmcMatrixValRe(tmsMatrix *res,long m,long n);
double tmcMatrixValIm(tmsMatrix *res,long m,long n);
double* tmcMatrixPRe(tmsMatrix *res,long m,long n);
double* tmcMatrixPIm(tmsMatrix *res,long m,long n);
//lapackutils
void tmcsvd_qd(long nout,long ninput,tmsMatrix *U,tmsMatrix *S,tmsMatrix *V,tmsMatrix *X,tmsMatrix *flag);
void tmcfft_qd(long nout,long ninput,tmsMatrix *out,tmsMatrix *in);
void tmceig_qd(long nout,long ninput,tmsMatrix *out1,tmsMatrix *out2,tmsMatrix *in1,tmsMatrix *in2,tmsMatrix *in3);
