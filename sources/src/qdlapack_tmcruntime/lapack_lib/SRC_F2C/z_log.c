...
doublereal (*gcc_bug_bypass_diff_F2C) ANSI((doublereal*,doublereal*));
 static doublereal
#ifdef KR_headers
diff1(a,b) doublereal *a, *b;
#else
diff1(doublereal *a, doublereal *b)
#endif
{ return *a - *b; }
#endif /*Pre20000310*/
...
#endif
{
	doublereal s, s0, t, t2, u, v;
	doublereal zi = z->i, zr = z->r;
#ifdef BYPASS_GCC_COMPARE_BUG
	doublereal (*diff) ANSI((doublereal*,doublereal*));
#endif
