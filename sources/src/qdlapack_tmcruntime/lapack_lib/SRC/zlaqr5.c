...
/*                 ==== A Bulge may collapse because of vigilant   
		    ...
		    i__7 = k + 3 + (k + 1) * h_dim1;
		    i__8 = k + 3 + (k + 2) * h_dim1;
		    if ((v[i__5].r != 0. || v[i__5].i != 0.) && (v[i__6].r != 
			    0. || v[i__6].i != 0. || h__[i__7].r == 0. && h__[
			    i__7].i == 0. && (h__[i__8].r == 0. && h__[i__8]
			    .i == 0.))) {
...
/*                    ==== Atypical case: collapsed.  Attempt to   
			...
			zlaqr1_(&c__3, &h__[k + 1 + (k + 1) * h_dim1], ldh, &
				s[(m << 1) - 1], &s[m * 2], vt);
			scl = (d__1 = vt[0].r, abs(d__1)) + (d__2 = d_imag(vt)
				, abs(d__2)) + ((d__3 = vt[1].r, abs(d__3)) + 
				(d__4 = d_imag(&vt[1]), abs(d__4))) + ((d__5 =
				 vt[2].r, abs(d__5)) + (d__6 = d_imag(&vt[2]),
				 abs(d__6)));
			if (scl != 0.) {
			    z__1.r = vt[0].r / scl, z__1.i = vt[0].i / scl;
			    vt[0].r = z__1.r, vt[0].i = z__1.i;
			    z__1.r = vt[1].r / scl, z__1.i = vt[1].i / scl;
			    vt[1].r = z__1.r, vt[1].i = z__1.i;
			    z__1.r = vt[2].r / scl, z__1.i = vt[2].i / scl;
			    vt[2].r = z__1.r, vt[2].i = z__1.i;
			}
...
/*                    ==== The following is the traditional and   
			...
			i__7 = k + 1 + (k + 1) * h_dim1;
			i__8 = k + 2 + (k + 2) * h_dim1;
			if (((d__1 = h__[i__5].r, abs(d__1)) + (d__2 = d_imag(
				&h__[k + 1 + k * h_dim1]), abs(d__2))) * ((
				d__3 = vt[1].r, abs(d__3)) + (d__4 = d_imag(&
				vt[1]), abs(d__4)) + ((d__5 = vt[2].r, abs(
				d__5)) + (d__6 = d_imag(&vt[2]), abs(d__6)))) 
				> ulp * ((d__7 = vt[0].r, abs(d__7)) + (d__8 =
				 d_imag(vt), abs(d__8))) * ((d__9 = h__[i__6]
				.r, abs(d__9)) + (d__10 = d_imag(&h__[k + k * 
				h_dim1]), abs(d__10)) + ((d__11 = h__[i__7].r,
				 abs(d__11)) + (d__12 = d_imag(&h__[k + 1 + (
				k + 1) * h_dim1]), abs(d__12))) + ((d__13 = 
				h__[i__8].r, abs(d__13)) + (d__14 = d_imag(&
				h__[k + 2 + (k + 2) * h_dim1]), abs(d__14)))))
				 {
...
/*                       ==== Starting a new bulge here would   
			    ...
			    i__5 = m * v_dim1 + 2;
			    i__6 = m * v_dim1 + 3;
			    if (v[i__5].r == 0. && v[i__5].i == 0. && (v[i__6]
				    .r == 0. && v[i__6].i == 0.)) {
				i__5 = m * v_dim1 + 1;
...
/*                       ==== Stating a new bulge here would   
			    ...
			    i__6 = k + 2 + k * h_dim1;
			    d_cnjg(&z__4, &vt[1]);
			    z__3.r = h__[i__6].r * z__4.r - h__[i__6].i * 
				    z__4.i, z__3.i = h__[i__6].r * z__4.i + 
				    h__[i__6].i * z__4.r;
			    z__2.r = h__[i__5].r + z__3.r, z__2.i = h__[i__5]
				    .i + z__3.i;
			    i__7 = k + 3 + k * h_dim1;
			    d_cnjg(&z__6, &vt[2]);
			    z__5.r = h__[i__7].r * z__6.r - h__[i__7].i * 
				    z__6.i, z__5.i = h__[i__7].r * z__6.i + 
				    h__[i__7].i * z__6.r;
			    ...
			    i__6 = k + 1 + k * h_dim1;
			    d_cnjg(&z__3, vt);
			    z__2.r = z__3.r * refsum.r - z__3.i * refsum.i, 
				    z__2.i = z__3.r * refsum.i + z__3.i * 
				    refsum.r;
			    z__1.r = h__[i__6].r - z__2.r, z__1.i = h__[i__6]
				    .i - z__2.i;
