...
/*  -- LAPACK auxiliary routine (version 3.1) --   
	...
	if (s == 0.) {
	    ...
	    h21s = z__1.r;
	    i__1 = (h_dim1 << 1) + 1;
	    z__2.r = h21s * h__[i__1].r, z__2.i = h21s * h__[i__1].i;
	    i__2 = h_dim1 + 1;
	    ...
	    z__1.r = h21s * z__2.r, z__1.i = h21s * z__2.i;
	...
	if (s == 0.) {
	    ...
	    z__3.r = z__4.r * z__5.r - z__4.i * z__5.i, z__3.i = z__4.r * 
		    z__5.i + z__4.i * z__5.r;
	    i__3 = (h_dim1 << 1) + 1;
	    z__7.r = h21s * h__[i__3].r, z__7.i = h21s * h__[i__3].i;
	    z__2.r = z__3.r + z__7.r, z__2.i = z__3.i + z__7.i;
	    i__4 = h_dim1 * 3 + 1;
	    z__8.r = h31s * h__[i__4].r, z__8.i = h31s * h__[i__4].i;
	    ...
	    z__2.r = h21s * z__3.r, z__2.i = h21s * z__3.i;
	    i__3 = h_dim1 * 3 + 2;
	    z__6.r = h31s * h__[i__3].r, z__6.i = h31s * h__[i__3].i;
	    ...
	    z__4.r = z__5.r - s1->r, z__4.i = z__5.i - s1->i;
	    z__3.r = z__4.r - s2->r, z__3.i = z__4.i - s2->i;
	    z__2.r = h31s * z__3.r, z__2.i = h31s * z__3.i;
	    i__3 = (h_dim1 << 1) + 3;
	    z__6.r = h21s * h__[i__3].r, z__6.i = h21s * h__[i__3].i;
	    z__1.r = z__2.r + z__6.r, z__1.i = z__2.i + z__6.i;
