...
@rem gcc -g -D TMCDEBUG %MYOPT% %MYOPT2% -D UNICODE -I../%TMCINC%/  -I./../Stubs/ @..\OutC_listC2.txt ../MexSRC/ExMex1.c ../App_caller/Extiny_caller.c  ../%TMCLIB%/%CPUTYPE%/%TMCLIBL% -lm -o ../%EXEDIR%/Ex1_%OUT_EX%_%TMCLIBLINK%.exe
gcc -g -mdll -static  -lstdc++ -D TMCDEBUG %MYOPT% %MYOPT2% -D UNICODE -I../%TMCINC%/  -I./../Stubs/ @..\OutC_listC2.txt ..\Stubs\NI_DllEx.c ..\Stubs\SIMO.def ..\Stubs\SIMO.def   ../MexSRC/ExMex1.c   ../%TMCLIB%/%CPUTYPE%/%TMCLIBL% -lm -o ../%EXEDIR%/SIMOR_%OUT_EX%_%TMCLIBLINK%.dll

cd ..
@rem Ex1_
@rem Ex1_x64.exe
@set PATH=%PATH%;..\..\lib\%CPUTYPE%\;
@rem %EXEDIR%\Ex1_%OUT_EX%_%TMCLIBLINK%.exe
