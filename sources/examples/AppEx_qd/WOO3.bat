...
@set GWIN_BINS=D:\Data_D\HSKOST\Tools\mingw-w64x86_64\mingw64\bin\
	...
	set TMCLIBLQD=tmcruntime_mingw_qd_w64.dll
	) else	(
...
@set GWIN_BINS=D:\Data_D\HSKOST\Tools\MinGW\bin\
	...
	set TMCLIBLQD=tmcruntime_mingw_qd_w32.dll
	) else	(
	echo static linking with TMCLIB
...
gcc -g -D TMCDEBUG %MYOPT% %MYOPT2%   -D UNICODE -I../../../include/  -I./../Stubs/ @..\OutC_listC2.txt ../MexSRC/ExMex1.c ../App_caller/Extiny_caller.c ./../../../lib/%CPUTYPE%/%TMCLIBLQD%  ./../../../lib/%CPUTYPE%/%TMCLIBL% -lm -o ../%EXEDIR%/Ex1_%OUT_EX%_%TMCLIBLINK%.exe
